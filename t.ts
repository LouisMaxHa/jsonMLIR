...
export class ModuleJsonOp {
  op: "module" = "module";
  body: (DefineStructOp | DefineFunctionOp | FunctionOp)[] = [];
  constructor(body: (DefineStructOp | DefineFunctionOp | FunctionOp)[] = []) {
    this.body = body;
  }
}
export class DefineStructOp {
  ...
  size: number;
  fields: StructField[];
  constructor(name: string, size: number, fields: StructField[]) {
    this.name = name;
    this.size = size;
    this.fields = fields;
  }
...
export class DefineFunctionOp {
  ...
  args: [string, TyNode][] = [];
  return_types: TyNode[] = [];
  constructor(name: string, args: [string, TyNode][] = [], return_types: TyNode[] = []) {
    this.name = name;
    this.args = args;
...
export class FunctionOp {
  ...
  args: [string, TyNode][] = [];
  body: JsonOp[] = [];
  constructor(name: string, args: [string, TyNode][] = [], body: JsonOp[] = []) {
    this.name = name;
    this.args = args;
    this.body = body;
  }
...
export class BinaryOp {
  ...
  rhs: JsonOp;
  ope: OperatorOp;
  constructor(lhs: JsonOp, rhs: JsonOp, ope: OperatorOp) {
    this.lhs = lhs;
    this.rhs = rhs;
    this.ope = ope;
  }
...
export class CallOp {
  ...
  name: string;
  args: JsonOp[] = [];
  constructor(name: string, args: JsonOp[] = []) {
    this.name = name;
    this.args = args;
  }
}
export class ConstOp {
  ...
  val: number;
  type: Scalar = "i64";
  constructor(val: number, type: Scalar = "i64") {
    this.val = val;
    this.type = type;
  }
}
export class IfOp {
  ...
  constructor(cond: JsonOp, thenBlock: JsonOp[], elseBlock: JsonOp[] | null = null) {
    this.cond = cond;
...
export class VarOp {
  ...
  constructor(name: string, indices: (number | string | VarOp)[] = [], type: TyNode | null = null) {
    this.name = name;
...
export class WhileOp {
  ...
  cond: JsonOp;
  thenBlock: JsonOp[] = [];
  constructor(cond: JsonOp, thenBlock: JsonOp[] = []) {
    this.cond = cond;
    this.thenBlock = thenBlock;
  }
}
...
export class SetOp {
  ...
  constructor(var_: VarOp, val: BinaryOp | ConstOp | VarOp | CallOp | UnaryOp) {
    this.var = var_;
    this.val = val;
  }
}
export class AllocOp {
  ...
  type: TyNode;
  size: (number | VarOp)[] = [];
  constructor(name: string, type: TyNode, size: (number | VarOp)[] = []) {
    this.name = name;
    this.type = type;
    this.size = size;
  }
...
export class MathOp {
  ...
  ope: MathOperator;
  value: JsonOp;
  constructor(ope: MathOperator, value: JsonOp) {
    this.ope = ope;
    this.value = value;
  }
}
export class UnaryOp {
  ...
  ope: UnaryOperator;
  value: JsonOp;
  constructor(ope: UnaryOperator, value: JsonOp) {
    this.ope = ope;
    this.value = value;
  }
}
...
export class TyMemref {
  ...
  dims: (number | null)[];
  base: TyNode;
  constructor(dims: (number | null)[], base: TyNode) {
    this.dims = dims;
    this.base = base;
  }
}
export class TyBuffer {
  ...
  dims: (number | null)[];
  base: string;
  constructor(dims: (number | null)[], base: string) {
    this.dims = dims;
    this.base = base;
  }
}
